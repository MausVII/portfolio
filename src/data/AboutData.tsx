...
const AboutData: React.FC = () => {
    ...
    return (
            <div className='about-div'>
                <div id='pic-div'>
                    <h1 id="about-name">Elan Locke</h1>
                ...
                <p>
                    ...
                    that gave me a head start into Software Development:
                        <br/>Software Development
                        <br/>Software Development Project
                        <br/>Machine Learning
                        <br/>Data Mining
                        <br/>Intro To SQL Databases<br/>
                    <BlinkingText text="..." interval_time={500} /><br />
                </p>
                <br />
                <p>
                    ...
                    <br/><BlinkingText text="..." interval_time={540} /><br />
                </p>
                <br />
                <p>
                <span className='commands'>~ work --ethic</span><br />
                    ...
                    <br/><BlinkingText text="..." interval_time={480} /><br />
                </p>
                <br />
                {/* <p>
                    <span className='commands'>~ software --drive</span><br />
                    I decided to delve into Software Development because there is no other fields where you can <span className='vars'>see the resuls of your work</span> as quickly and as strikingly;
                    every line of JavaScript will immediately render itself in a web app. It is also a field where you can <span className='vars'>express yourself</span> visually and artistically; for each
                    ...
                    <br/><BlinkingText text="..." interval_time={520} /><br />
                </p> */}
                </div>
